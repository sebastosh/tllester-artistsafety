...
We are in the process of opening up the Creative Safe Haven process; therefore we provide technical assistance to any art space (regardless of network membership) wishing to host culture workers-in-distress, combined with support to partner networks that wish to include Creative Safe Haven on their menu of offerings. This is achieved using [video tutorials](http://www.vimeo.com/album/1438810) and a [‘how to’ guide](http://freedimensional.org/wp-content/uploads/2010/10/fD_Final_6Octt.pdf) created with the help of [New Tactics in Human Rights](http://www.newtactics.org/en/ArtSpaces), which are disseminated through online, DVD, print and workshop formats. We continue to match culture workers-in-distress with partner art spaces; however we want to encourage art spaces to identify and respond to local and regional issues for which our tools can be useful.

[Read case study.](http://freedimensional.org/about/case-studies/issa-nyaphaga/)

[See the how-to guide: “Art Spaces Hosting Activism: Using surplus resources to provide individual assistance and strengthen community engagement”.](http://freedimensional.org/resources/tactical-notebook/)
